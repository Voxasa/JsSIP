...
module.exports = class WebSocketInterface
{
  ...
  disconnect()
  {
    ...
    if (this._ws)
    {
      ...
      // Trigger JsSIP's automatic reconnection by calling ondisconnect
      // This is needed for network switch recovery
  ...
  /**
   * Reconnect the WebSocket - triggers disconnect then reconnect flow
   * Used for network switch recovery (WiFi -> Cellular)
   */
  reconnect()
  {
